config = {
	timeToRob = 120, -- In seconds
	robberyCooldown = 30, -- In minutes
	...
	robberySuccess = "^2^*The robbery was successful. ^5^rNext robbery can be activated in ^1^*30 ^5^rminutes.",
	robberyFailed = "^1^*The robbery has failed. ^5^rNext robbery can be activited in ^1^*30 ^5^rminutes",
